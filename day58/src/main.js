...
function animate() {
  ...
  if(isHovered) {
    ...
    targetX = localPoint.x * edgeStrength;
    targetY = localPoint.y * edgeStrength;
    targetLightX = localPoint.x;
    targetLightY = localPoint.y;
    targetLightIntensity = strongStrength * 3;
  ...
  pointLight.position.x += (targetLightX - pointLight.position.x) * 0.06;
  pointLight.position.y += (targetLightY - pointLight.position.y) * 0.06;
  pointLight.intensity += (targetLightIntensity - pointLight.intensity) * 0.06;
